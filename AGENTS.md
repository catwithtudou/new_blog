...
2. Stages source/config changes
3. Creates a single commit with the provided message
4. Pushes to the specified branch (defaults to main)
5. Lets GitHub Actions deploy the site
